...
function Admin() {
  ...
  const fetchUserInfo = async (mail) => {
    var options = {
      method: "GET",
      url:
        "https://the-sanjivani-ngo-server.onrender.com/api/v1/search/donations?email=" +
        mail,
      headers: {
  ...
  const search = async () => {
    ...
    var options = {
      method: "GET",
      url:
        "https://the-sanjivani-ngo-server.onrender.com/api/v1/search/" + query,
      headers: {
        Authorization: `Basic ${auth}`,
        "Content-Type": "application/json",
      },
    ...
    <>
      ...
      <div className="admin">
        <div className="container ">
                ...
                <div className="popupContent" id="myPopup">
                  ...
                  <div className="card">
                    <div className="card-body">
                      <h1 className="text-center text-warning p-3 bg-dark rounded-top-4">
                        THE SANJIVANI NGO
                      </h1>
                        ...
                        <tbody className="text-start">
                          ...
                          <tr>
                            ...
                            <td scope="col">
                              {isEnabled ? (
                                <i
                                  className="fa fa-solid fa-circle-check fa-lg"
                                  style={{ color: "green" }}
                                />
                              ) : (
                                <i
                                  className="fa fa-solid fa-circle-xmark fa-lg"
                                  style={{ color: "red" }}
                                />
                              )}
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              {totalAmount} <i className="fa fa-indian-rupee" />
                            </td>
                          </tr>
                          <tr>
          ...
          <h2 className="text-center text-light text-uppercase font-monospace fw-bold">
            ADMIN
          </h2>
          <div className="search-container pt-3 pb-4">
            <input
              ...
              onKeyUp={search}
              id="search-input"
              className="form-control bg-dark text-light fs-5 me-2"
              type="search"
          ...
          >
            <table className="table table-borderless table-dark table-hover">
              <caption className="caption-top text-light">
                List of Donations
              </caption>
                      ...
                      <div className="btn-group">
                        ...
                        >
                          {donation.orderIds.map((orderId, i) => (
                            <li key={i} className="dropdown-item text-success">
                              {orderId}: {donation.amounts[i]}{" "}
                              <i className="fa fa-indian-rupee" />
                            </li>
                          ))}
                        </ul>
                      </div>
